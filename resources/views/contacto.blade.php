            ...
            <div class="col-12 col-md-12 col-lg-12">
                <ul class="nav nav-tabs" id="myTab" role="tablist">
                    <li class="nav-item" role="presentation" id="seccionFormContactanosForm">
                        <button class="nav-link {{ $claseFormContactanos }}" id="formularioContactanos"
                    ...
                    <li class="nav-item" role="presentation" id="formularioQuejasYSugerencias">
                        <button class="nav-link" id="seccionQuejasySugerencias" data-bs-toggle="tab" data-bs-target="#sugerencia-pane"
