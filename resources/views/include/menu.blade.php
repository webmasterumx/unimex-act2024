        ...
        <nav class="subnav" id="alumnosegresados">
            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-xl-2 col-lg-2 col-md-3 col-sm-12 left-gray-border">
                        {{--  href="javascript:void(0);" onClick="window.open('{{ asset('assets/pdf/reglamentoum.pdf') }}','Reglamento UNIMEX','scrollbars=no,width=580,height=600')" --}}
                        <h5 class="hide">
                        ...
                        <div class="card" style="min-height: 150px;">
                            ...
                            <div class="card-body">
                                <p class="card-text" style="text-align: center;">
                                    <a href="{{ route("reglamentoUnimex") }}"><span class="blue-text">Reglamento UNIMEX<sup>®</sup></span></a>
