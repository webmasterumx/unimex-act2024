...
@section('styles')
    ...
    <link async rel="stylesheet" href="{{ asset('assets/css/prettify.css') }}">
@endsection
                    ...
                    <div class="tab-pane" id="tab1">
                        <div class="container-fluid">
                            <div class="pleca-pregunta">
                                ...
                                <div class="row">
                                    <div class="col-sm-6">
                                        <div class="imgBorder"><img src="{{ asset('assets/img/testVocacional/1.webp') }}" class="lazyload img-responsive">
                                        </div>
                                    </div>
                                    <div class="col-sm-6">
